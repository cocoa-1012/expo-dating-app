        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.headerRow}>
                    ...
                    <Text style={styles.textprofile}>Withdraw</Text>
                </View>
            </View>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.paddingView}>
                    <LinearGradient style={styles.inputGrad} colors={['rgba(196, 196, 196, 0.36)', 'rgba(184, 184, 184, 0.17)',]}>
                        <Image resizeMode="cover" style={styles.crownImg} source={require('../Images/paypal.png')} />
                        <View style={{ width: '100%', marginBottom: 20 }}>
                            <LinearGradient style={styles.inputGradText} colors={['rgba(196, 196, 196, 0.27)', 'rgba(196, 196, 196, 0.16)',]}>
                                <TextInput
                                    placeholder="Email"
                        ...
                        <Text style={{ color: '#fff', fontSize: 14, marginBottom: 20, textAlign: 'center' }}>You have to verify your email to withdraw money</Text>
