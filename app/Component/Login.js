...
import { StyleSheet, View, Text, ScrollView, Image, StatusBar, TouchableOpacity, Linking, TextInput } from 'react-native'
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.paddingView}>
                    <View style={{ marginBottom: 20 }}>
                        <Text style={styles.welcomText}> Welcome to Hide & Seek </Text>
                    </View>
                    <TextInput placeholder="Email Id" style={styles.emailText} />
                    <TextInput placeholder="Password" style={styles.emailText} />
                    <TouchableOpacity style={styles.forgotPass} onPress={() => navigation.navigate('ChangePassword')}>
                        <Text style={{ color: '#fff', fontSize: 14, fontWeight: 'bold' }}>Forgot Password?</Text>
                    </TouchableOpacity>
                    {/* <TouchableOpacity style={styles.facBtn} onPress={() => navigation.navigate('MakeProfile')}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('MakeProfile')}>
                        <LinearGradient style={styles.googleBtn} colors={['rgba(196, 196, 196, 0.27)', 'rgba(196, 196, 196, 0.16)',]} >
                            <Text style={styles.faceText}>Login</Text>
                        </LinearGradient>
                    </TouchableOpacity>
                    <View style={styles.signupBtn}>
                        <Text style={{ color: '#fff', fontSize: 14 }}>Don't have an account?</Text>
                        <TouchableOpacity onPress={()=>navigation.navigate('Registor')}>
                            <Text style={{ color: '#fff', fontSize: 14, fontWeight: 'bold', marginLeft: 8 }}>sign up</Text>
                            </TouchableOpacity>
                    </View>
