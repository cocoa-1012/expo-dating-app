            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.paddingView}>
                    <LinearGradient style={styles.inputGrad} colors={['rgba(196, 196, 196, 0.36)', 'rgba(184, 184, 184, 0.17)',]}>
                        ...
                        <Text style={{ color: '#fff', fontSize: 30, marginBottom: 20 }}>$30</Text>
                        <TouchableOpacity activeOpacity={0.4} style={styles.continueBtn} onPress={() => navigation.navigate('Payment2')}>
                            <Text style={{ color: '#fff', fontSize: 18 }}>Varify</Text>
                        </TouchableOpacity>
                    </LinearGradient>
                </View>
            </ScrollView>
