...
import { StyleSheet, View, Text, Image, StatusBar, TouchableOpacity, TextInput, ScrollView, Dimensions, Platform } from 'react-native'
import { LinearGradient } from "expo-linear-gradient";
import Font from 'react-native-vector-icons/FontAwesome';
import TopTabNavigator3 from './TopTabNavigator3';
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.paddingView}>
                    <View style={styles.borderBottom}>
                        ...
                        <Text style={{ color: '#fff', fontSize: 24, marginBottom: 4 }}>Compitition July 2020</Text>
                        <Text style={{ color: '#EE3C90', fontSize: 13, marginBottom: 4 }}>Valid till - 30 july 2020</Text>
                    </View>
